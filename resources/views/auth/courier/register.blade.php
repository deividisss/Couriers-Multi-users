...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Courier') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <input type="hidden" name="courier" value="true">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="registration_code" type="registration_code" class="form-control{{ $errors->has('registration_code') ? ' is-invalid' : '' }}" name="registration_code" value="{{ old('registration_code') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="VAT" type="VAT" class="form-control{{ $errors->has('VAT') ? ' is-invalid' : '' }}" name="VAT" value="{{ old('VAT') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="logo" type="logo" class="form-control{{ $errors->has('logo') ? ' is-invalid' : '' }}" name="logo" value="{{ old('logo') }}" required>
